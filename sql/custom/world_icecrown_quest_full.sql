...
UPDATE `quest_template` SET `RequiredSkillId`=-32 WHERE `Id` IN (13795, 13791, 13813, 13788, 13812, 13793, 13814, 13864, 13863);
...
-- Among the Champions (A, H)
-- Battle Before The Citadel (A, H)
UPDATE `quest_template` SET `RequiredSkillId`=-1503 WHERE `Id` IN (13794, 13788, 13789, 13810, 13682, 13809, 13790, 13811, 13861, 13862);
