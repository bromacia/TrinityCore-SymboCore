...
void Pet::SavePetToDB(PetSaveMode mode)
{
    ...
    if (mode >= PET_SAVE_AS_CURRENT)
    {
        ...
        ss  << "REPLACE INTO character_pet (id, entry,  owner, modelid, level, exp, Reactstate, slot, name, renamed, curhealth, curmana, curhappiness, abdata, savetime, CreatedBySpell, PetType) "
            << "VALUES ("
