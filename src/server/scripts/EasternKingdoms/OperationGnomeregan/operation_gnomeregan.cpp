            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 5:
                        ...
                        break;
                    default:
                        TC_LOG_ERROR("scripts", "Unexpected movement variation (%i) in npc_og_suitAI::SetupMovement call!", variation);
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 18:
                        ...
                        break;
                    default:
                        TC_LOG_ERROR("scripts", "Unexpected movement variation (%i) in npc_og_infantryAI::SetupMovement call!", variation);
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        TC_LOG_ERROR("scripts", "Unexpected movement variation (%i) in npc_og_tankAI::SetupMovement call!", variation);
                        return;
                }
            ...
            void SetupMovement(uint32 variation)
            {
                switch (variation)
                {
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        TC_LOG_ERROR("scripts", "Unexpected movement variation (%i) in npc_og_i_tankAI::SetupMovement call!", variation);
                        return;
                }
    ...
    public:
        ...
        struct npc_og_mekkatorqueAI : public npc_escortAI
        {
                ...
                if (uiStep_timer <= diff)
                {
                    switch (uiStep)
                    {
                        ...
                        case 18:
                            ...
                            me->SummonGameObject(GO_RAD_CONTROL, RadControlSpawn.GetPositionX(), RadControlSpawn.GetPositionY(), RadControlSpawn.GetPositionZ(), 0, 0, 0, 0, 0, TEMPSUMMON_MANUAL_DESPAWN);
                            for (int8 n = 0; n < 3; ++n)
            ...
            void SpecialKill(uint32 variation)
            {
                switch (variation)
                {
                        ...
                        if (uiStep > 14)
                        {
                            switch (uiRLDestroyed)
                            {
                                ...
                                case 4:
                                    break;
                                //default:
                                    TC_LOG_ERROR("scripts", "More than 4 Rocket Launchers destroyed!");
                            }
                        }
                        break;
                    case 1:
                        ...
                        if (uiCannonsDestroyed > 6)
                            TC_LOG_ERROR("scripts", "More than 6 Tankbuster Cannons destroyed!");
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        break;
                    //default:
                        TC_LOG_ERROR("scripts", "Unexpected variation (%i) in npc_og_mekkatorqueAI::SpecialKill call!", variation);
                }
            }
            ...
            void DoPlayMusic(uint8 musicId)
            {
                switch (musicId)
                {
                    ...
                    case 2:
                        ...
                        break;
                    //default:
                        TC_LOG_ERROR("scripts", "Unexpected musicId (%i) in npc_og_mekkatorqueAI::DoPlayMusic call!", musicId);
                }
            }
            ...
            void UpdateBannerState(float radius)
            {
                ...
                //else
                    TC_LOG_ERROR("scripts", "TSCR error: BannerList is empty!");
            }
